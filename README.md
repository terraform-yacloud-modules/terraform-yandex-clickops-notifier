...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_audit_trails"></a> [audit\_trails](#module\_audit\_trails) | git::https://github.com/terraform-yacloud-modules/terraform-yandex-audit-trails.git | v2.23.0 |
| <a name="module_audit_trails_logging_group"></a> [audit\_trails\_logging\_group](#module\_audit\_trails\_logging\_group) | git::https://github.com/terraform-yacloud-modules/terraform-yandex-logging-group.git | v1.21.0 |
...
| <a name="module_function_logging_group"></a> [function\_logging\_group](#module\_function\_logging\_group) | git::https://github.com/terraform-yacloud-modules/terraform-yandex-logging-group.git | v1.21.0 |
...
| <a name="module_kms_key"></a> [kms\_key](#module\_kms\_key) | git::https://github.com/terraform-yacloud-modules/terraform-yandex-kms.git | v1.29.0 |
