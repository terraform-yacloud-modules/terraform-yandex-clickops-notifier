...
module "lockbox" {
  source = "git::https://github.com/terraform-yacloud-modules/terraform-yandex-lockbox.git?ref=rc/1.18.0"
...
module "function" {
  source = "git::https://github.com/terraform-yacloud-modules/terraform-yandex-function.git?ref=rc/1.12.0"
