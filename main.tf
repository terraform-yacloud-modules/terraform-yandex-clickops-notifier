module "iam_account" {
  source = "git::https://github.com/terraform-yacloud-modules/terraform-yandex-iam.git//modules/iam-account?ref=v1.28.0"
...
module "kms_key" {
  source = "git::https://github.com/terraform-yacloud-modules/terraform-yandex-kms.git?ref=v1.29.0"
...
module "audit_trails" {
  source = "git::https://github.com/terraform-yacloud-modules/terraform-yandex-audit-trails.git?ref=v2.23.0"
