...
module "kms_key" {
  source = "git::https://github.com/terraform-yacloud-modules/terraform-yandex-kms.git?ref=v1.32.0"
...
module "audit_trails" {
  source = "git::https://github.com/terraform-yacloud-modules/terraform-yandex-audit-trails.git?ref=v2.25.0"
