module "iam_account" {
  source = "git::https://github.com/terraform-yacloud-modules/terraform-yandex-iam.git//modules/iam-account?ref=v1.38.0"
...
module "kms_key" {
  source = "git::https://github.com/terraform-yacloud-modules/terraform-yandex-kms.git?ref=v1.38.0"
...
module "audit_trails" {
  source = "git::https://github.com/terraform-yacloud-modules/terraform-yandex-audit-trails.git?ref=v2.30.0"
...
module "function_logging_group" {
  source = "git::https://github.com/terraform-yacloud-modules/terraform-yandex-logging-group.git?ref=v1.30.0"
